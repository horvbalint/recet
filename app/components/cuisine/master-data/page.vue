...
const columns = computed(() => ({
  name: { text: t('masterData.cuisine.columns.name') },
  flag: { text: t('masterData.cuisine.columns.flag') },
  color: { text: t('masterData.cuisine.columns.color') },
...
<template>
  <master-data-layout
    table="cuisine"
    :name="$t('masterData.cuisine.name')"
